...
const updateDutyTimingSettingsSchema = z.object({
  ...
  not_checked_in_morning_hour:   hour.optional(),
  not_checked_in_morning_min:    minute.optional(),
  not_checked_in_afternoon_hour: hour.optional(),
  not_checked_in_afternoon_min:  minute.optional(),
