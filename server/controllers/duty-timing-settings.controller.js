...
// Validates session_start < late_threshold <= auto_checkout, expressed in
// minutes-since-midnight, against the fully merged (existing + incoming) row —
// a partial PATCH can only be judged correctly once merged.
